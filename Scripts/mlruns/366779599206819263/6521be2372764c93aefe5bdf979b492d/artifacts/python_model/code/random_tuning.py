...
def perform_random_search_by_keyboard_input(x_train: list[str], y_train: list[str], deduplicated: bool) -> None:
    """
...
def main(keyboard_input: bool=True):
    ...
    if keyboard_input:
        perform_random_search_by_keyboard_input(x_train=x_train, y_train=y_train, deduplicated=deduplicated_bool)
